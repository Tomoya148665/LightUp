...
const Person: FunctionComponent<PersonType> = ({
  ...
  return (
    <div className="w-[259px] box-border flex flex-row items-center justify-start py-1.5 px-[15px] gap-[8px] text-left text-5xs text-text-dart font-roboto border-[1px] border-solid border-darkgray-100">
